...
struct Elf32 : public ElfTypes {
  ...
  template <typename t32, typename t64> struct pick {
    typedef t32 t;
  };
};
...
struct Shdr {
  ...
  typename E::template pick<typename E::Word, shf>::t
...
template <byte_order Order> struct Phdr<Elf32, Order> {
  typedef Elf32 types;
  static const byte_order order = Order;
...
template <byte_order Order> struct Phdr<Elf64, Order> {
  typedef Elf64 types;
  static const byte_order order = Order;
...
template <typename E = Elf64, byte_order Order = byte_order::native> struct Sym;

template <byte_order Order> struct Sym<Elf32, Order> {
  typedef Elf32 types;
  static const byte_order order = Order;
...
template <byte_order Order> struct Sym<Elf64, Order> {
  typedef Elf64 types;
  static const byte_order order = Order;
